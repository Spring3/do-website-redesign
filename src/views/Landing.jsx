...
import { clients, partners } from '../fixtures';
...
import Iconsets from '../components/Iconset';
    ...
    <Fragment>
      ...
      <main>
        ...
        <section>
          ...
          >
            <Plate
              ...
              icon={<DiamondOutlineIcon size={40} />}
            >
            ...
            <Plate
              header="Plug & Play"
              icon={<ControllerClassicOutlineIcon size={40}/>}              
            >
            ...
            <Plate
              ...
              icon={<CellphoneLinkIcon size={40}/>}
            >
            ...
            <Plate
              ...
              icon={<AccountSearchOutlineIcon size={40}/>}
            >
            ...
            <Plate
              ...
              icon={<AccountGroupOutlineIcon size={40}/>}
            >
            ...
            <Plate
              ...
              icon={<MonitorDashboardIcon size={40}/>}
            >
            ...
            <Plate
              ...
              icon={<ChartBarStackedIcon size={40}/>}
            >
            ...
            <Plate
              ...
              icon={<AccountCardDetailsIcon size={40}/>}
            >
            ...
            <Plate
              ...
              icon={<ToggleSwitchOutlineIcon size={40}/>}
            >
        ...
        <section>
          ...
          >
            <div className="solution">
              <aside>
                <Slider>
                  <ImageSlide>
                    <IPhoneFrame>
                      <img src="click2hub1.png" alt='click2hub'/>
                    </IPhoneFrame>
                  </ImageSlide>
                  <ImageSlide>
                    <IPhoneFrame>
                      <img src="click2hub.png" alt='click2hub'/>
                    </IPhoneFrame>
                  </ImageSlide>
                </Slider>
              </aside>
            ...
            <div className="solution">
              <aside>
                <IPhoneFrame>
                  <img src='sms2hub.png' alt='sms2hub'/>
                </IPhoneFrame>
              </aside>
              <div className="content">
                <h2 className="caption">Trigger the visual IVR from SMS</h2>
                <ul className="benefits">
            ...
            <div className="solution">
              <aside>
                <Slider>
                  <ImageSlide>
                    <IPhoneFrame>
                      <img src="call2hub.png" alt='call2hub'/>
                    </IPhoneFrame>
                  </ImageSlide>
                  <ImageSlide>
                    <IPhoneFrame>
                      <img src="click2hub.png" alt='call2hub'/>
                    </IPhoneFrame>
                  </ImageSlide>
                </Slider>
              </aside>
              <div className="content">
                <h2 className="caption">Intercept the call and trigger the visual IVR instead.</h2>
                <ul className="benefits">
            ...
            <div className="solution">
              <aside>
                <IPhoneFrame>
                  <img src="offlineMode.png" alt="offlineMode"/>
                </IPhoneFrame>
              </aside>
              <div className="content">
                <h2 className="caption">Get access to the visual IVR while offline.</h2>
                <ul>
            ...
            <div className="solution">
              <div className="content">
                <h2 className="caption">Send user metadata to your support center to provide basic info about the call.</h2>
                <ul className="benefits">
            ...
            <div className="solution">
              <div className="content">
                <h2 className="caption">Let you caller trigger the visual IVR if you are in busy / sleep mode.</h2>
                <ul>
                  <li>User self-service</li>
                  <li>Reduced amount of calls</li>
                </ul>
        ...
        <section className="clients">
          <h1>Our Clients</h1>
          <Iconsets iconsets={clients} height={80} width={100} />
        </section>
        <section className="partners">
          <h1>Our Partners</h1>
          <Iconsets iconsets={partners} height={80} width={100} />
        </section>
